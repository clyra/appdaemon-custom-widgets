function baseservice(widget_id, url, skin, parameters)
{
	...
	if ("service_data" in self.parameters)
        {
            for (var attr in self.parameters.service_data)
            {
                 args[attr] = self.parameters.service_data[attr]
            }
        }
        console.log(args);
